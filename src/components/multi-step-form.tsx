...
// SSN, BirthDay, Photo, CompletionScreen steps are removed from here as they belong to AttendanceForm
...
// Stepper labels are not strictly needed if stepper is hidden for phone step
// const stepLabels = ["Phone"]; 
  ...
  const nextStep = async () => {
    ...
    if (currentStep === 1 && canProceed) {
      ...
      try {
        ...
        if (response.ok) { // Includes 200, 210, etc.
          if (responseText) {
            try {
